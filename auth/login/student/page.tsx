...
import { ArrowLeft, Users, Lock, Mail, Eye, EyeOff, AlertCircle } from "lucide-react";
...
function StudentLoginForm() {
  ...
  const redirectUrl = searchParams.get("redirect") || searchParams.get("callbackURL") || "/dashboard/student";
      ...
      <div className="container mx-auto px-4 py-12">
        <nav className="mb-4 text-sm text-gray-600 dark:text-gray-400" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2">
            ...
            <li><span>/</span></li>
            <li><span className="text-gray-900 dark:text-gray-100">Student Login</span></li>
          </ol>
        </nav>
            ...
            <CardContent>
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <div className="text-center text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <Link 
                    href={`/auth/register/student${redirectUrl !== "/dashboard/student" ? `?redirect=${encodeURIComponent(redirectUrl)}` : ""}`}
