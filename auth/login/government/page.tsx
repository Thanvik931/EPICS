...
import { ArrowLeft, Landmark, Lock, Mail, Shield, Eye, EyeOff, AlertCircle } from "lucide-react";
...
function GovernmentLoginForm() {
  ...
  const redirectUrl = searchParams.get("redirect") || searchParams.get("callbackURL") || "/dashboard/government";
      ...
      <div className="container mx-auto px-4 py-12">
        <nav className="mb-4 text-sm text-gray-600 dark:text-gray-400" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2">
            <li><Link href="/" className="hover:text-green-600 dark:hover:text-green-400">Home</Link></li>
            <li><span>/</span></li>
            <li><span className="text-gray-900 dark:text-gray-100">Government Portal</span></li>
          </ol>
        </nav>
        ...
        >
          <Card className="shadow-xl">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-3xl">Government Portal</CardTitle>
              <CardDescription className="text-base">
                Secure access to national alumni data and analytics
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="mb-6 rounded-lg border border-green-200 bg-green-50 p-4 dark:border-green-800 dark:bg-green-900/20">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-green-800 dark:text-green-300">
                    ...
                    <p className="mt-1">This portal requires authorized government credentials</p>
                  </div>
                </div>
              </div>
              ...
              <form onSubmit={handleLogin} className="space-y-6">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <label htmlFor="remember" className="cursor-help text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                          Remember me
                        </label>
                      </TooltipTrigger>
                      <TooltipContent>
                ...
                <div className="text-center text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <Link 
                    href={`/auth/register/government${redirectUrl !== "/dashboard/government" ? `?redirect=${encodeURIComponent(redirectUrl)}` : ""}`}
                ...
                <div className="text-center text-sm">
                  <Link href="/help" className="text-green-600 hover:text-green-700 dark:text-green-400">
