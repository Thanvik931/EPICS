...
import { ArrowLeft, Building, Lock, Mail, Eye, EyeOff, AlertCircle } from "lucide-react";
...
function UniversityLoginForm() {
  ...
  const redirectUrl = searchParams.get("redirect") || searchParams.get("callbackURL") || "/dashboard/university";
      ...
      <div className="container mx-auto px-4 py-12">
        <nav className="mb-4 text-sm text-gray-600 dark:text-gray-400" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2">
            <li><Link href="/" className="hover:text-orange-600 dark:hover:text-orange-400">Home</Link></li>
            <li><span>/</span></li>
            <li><span className="text-gray-900 dark:text-gray-100">University Portal</span></li>
          </ol>
        </nav>
        ...
        >
          <Card className="shadow-xl">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-3xl">University Portal</CardTitle>
              <CardDescription className="text-base">
                Access institutional analytics and alumni management
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <div className="text-center text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <Link 
                    href={`/auth/register/university${redirectUrl !== "/dashboard/university" ? `?redirect=${encodeURIComponent(redirectUrl)}` : ""}`}
                ...
                <div className="text-center text-sm">
                  <Link href="/help" className="text-orange-600 hover:text-orange-700 dark:text-orange-400">
